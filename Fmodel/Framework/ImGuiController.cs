...
public class ImGuiController : IDisposable
{
    ...
    public ImGuiController(int width, int height)
    {
        ...
        {
            System.Diagnostics.Debug.WriteLine($"字体加载错误：{ex.Message}");
        }
...
outputColor = color * texture(in_fontTexture, texCoord);
    ...
    public void RecreateFontDeviceTexture()
    {
        ...
        LabelObject(ObjectLabelIdentifier.Texture, _fontTexture, "ImGui文字图集");
    ...
    public static int CreateProgram(string name, string vertexSource, string fragmentSoruce)
    {
        ...
        LabelObject(ObjectLabelIdentifier.Program, program, $"程序: {name}");
        ...
        if (success == 0)
        {
            ...
            Debug.WriteLine($"GL.LinkProgram有日志信息[{name}]:\n{info}");
        }
