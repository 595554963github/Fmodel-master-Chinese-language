...
public partial class DictionaryEditor
{
    ...
    public DictionaryEditor(string title)
    {
        ...
        _defaultOptions = new Dictionary<string, bool> { { "密钥1", true }, { "密钥2", false } };
        _defaultMapStructTypes = new Dictionary<string, KeyValuePair<string, string>> { { "映射名称", new KeyValuePair<string, string>("密钥类型", "值类型") } };
